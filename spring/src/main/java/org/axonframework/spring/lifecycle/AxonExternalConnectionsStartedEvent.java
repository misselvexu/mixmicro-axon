 ...
 */
public class AxonExternalConnectionsStartedEvent extends AxonLifecycleStartEvent {
    protected AxonExternalConnectionsStartedEvent() {
        super(Phase.EXTERNAL_CONNECTIONS);
    }
}
