 ...
 */
public class AxonInboundCommandConnectorsStartedEvent extends AxonLifecycleStartEvent {
    protected AxonInboundCommandConnectorsStartedEvent() {
        super(Phase.INBOUND_COMMAND_CONNECTOR);
    }
}
