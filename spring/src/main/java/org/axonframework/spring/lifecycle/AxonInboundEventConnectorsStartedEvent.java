 ...
 */
public class AxonInboundEventConnectorsStartedEvent extends AxonLifecycleStartEvent {
    protected AxonInboundEventConnectorsStartedEvent() {
        super(Phase.INBOUND_EVENT_CONNECTORS);
    }
}
