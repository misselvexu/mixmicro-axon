 ...
 */
public class AxonInstructionComponentsStartedEvent extends AxonLifecycleStartEvent {
    protected AxonInstructionComponentsStartedEvent() {
        super(Phase.INSTRUCTION_COMPONENTS);
    }
}
