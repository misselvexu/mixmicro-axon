 ...
 */
public class AxonOutboundCommandConnectorsStartedEvent extends AxonLifecycleStartEvent {
    protected AxonOutboundCommandConnectorsStartedEvent() {
        super(Phase.OUTBOUND_COMMAND_CONNECTORS);
    }
}
