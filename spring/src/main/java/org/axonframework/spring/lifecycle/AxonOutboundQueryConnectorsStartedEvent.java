 ...
 */
public class AxonOutboundQueryConnectorsStartedEvent extends AxonLifecycleStartEvent {
    protected AxonOutboundQueryConnectorsStartedEvent() {
        super(Phase.OUTBOUND_QUERY_CONNECTORS);
    }
}
